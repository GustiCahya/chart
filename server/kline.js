...
const server = app.listen("4000", () =>
  log(`Kline Data Server started on port 4000`)
);
const socket = require("socket.io");
const io = socket(server);

const bRest = new api.BinanceRest({
  key: "kLBq4RIU8YogfiT54v07a7epfRjUipMQq2bw3rJrIqIARfW7NJovuaNNBix0W4j9", // Get this from your account on binance.com
  secret: "jwr2IsalcWQHJ9CnVDJIyRXxsuwwQhuWIwLdsmcHjzIzJD2szjFfyog7EXF6bAsP", // Same for this
